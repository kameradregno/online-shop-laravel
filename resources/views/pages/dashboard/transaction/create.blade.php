                ...
                <form action="{{ route('dashboard.product.store') }}" class="w-full" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3 -mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" placeholder="Product Name" value="{{ old('title') }}" name="title"
                    ...
                    <div class="flex flex-wrap -mx-3 -mb-6">
                        <div class="w-full px-3 mb-8 mt-8">
                            ...
                            <textarea name="description" id="description"
                                class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight outline-none focus:outline-none focus:bg-white focus:border-pink-500">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-3 -mb-6">
                        <div class="w-full px-3 mb-6">
                            ...
                            <input type="text" value="{{ old('qty') }}" name="qty"
                                class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight outline-none focus:outline-none focus:bg-white focus:border-pink-500">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-3 -mb-6">
                        <div class="w-full px-3 mt-6">
                            <button type="submit" class="bg-pink-400 text-white font-bold py-2 px-4 rounded shadow-lg">Simpan</button>
                        </div>
                    </div>

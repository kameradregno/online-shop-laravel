<!-- START: HEADER -->
<header class="{{ \Route::current()->getName() == 'index' ? 'absolute' : '' }} a w-full z-50 px-4">
            ...
            <div class="w-auto">
                <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                    ...
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : '' }} hover:underline">Showcase</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : '' }} hover:underline">Catalog</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : '' }} hover:underline">Delivery</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"

        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                ->addColumn('action', function ($item) {
                    ...
                    <button class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold mx-2 py-1.5 px-3 rounded shadow-lg" type="submit">
                        Delete
                    </button>
                ...
                ->editColumn('url', function ($item) {
                    return '<img style="max-width: 150px" src="' . Storage::url($item->url_name) . '"/>';
                })
